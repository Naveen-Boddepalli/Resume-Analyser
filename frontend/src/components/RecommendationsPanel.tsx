...
export function RecommendationsPanel({
  ...
  return (
    <div className="bg-card border border-border rounded-xl p-6 w-full max-w-4xl mx-auto shadow-sm">
      ...
      <ul className="space-y-4">
        {recommendations.map((rec, index) => (
          <li
            key={index}
            className="flex items-start p-4 rounded-lg bg-muted/50 border border-muted"
          >
